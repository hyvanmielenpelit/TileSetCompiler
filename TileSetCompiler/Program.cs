...
namespace TileSetCompiler
{
    ...
    class Program
    {
        ...
        public static int MaxTilesPerTileSet { get { return _maxTilesPerTileSet; } }
        public static Size MaxTileSetSize { get { return _maxTileSetSize;  } }
        ...
        public static Dictionary<int, int> TileSetTileCount { get; set; }
        public static int FoundTileCount { get; set; }
        public static int MissingTileCount { get; set; }
        public static int AutoGeneratedTileCount { get; set; }
        public static int AutoGeneratedMissingTileCount { get; set; }
        public static int TileNumberFromTemplate { get; set; }
        public static int TilesReplacedWithAnother { get; set; }
        public static int CurrentTileSet { get; set; }
        ...
        static void Main(string[] args)
        {
            ...
            using (TileCompiler = new TileCompiler())
            {
                try
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Total Tiles: {0}", TileCount);
                    Console.WriteLine("Found Tiles: {0}", FoundTileCount);
                    Console.WriteLine("Missing Tiles: {0}", MissingTileCount);
                    Console.WriteLine("Auto-Generated Tiles: {0}", AutoGeneratedTileCount);
                    Console.WriteLine("Missing Auto-Generated Tiles: {0}", AutoGeneratedMissingTileCount);
        ...
        {
            TileCount += TileCompiler.GetTileNumber();
            TileSetCount = TileCount == 0 ? 1 : (TileCount - 1) / MaxTilesPerTileSet + 1;
            TileSetSizes = new Dictionary<int, Size>();
            TileSetTileCount = new Dictionary<int, int>();

            for(int i = 0; i < TileSetCount; i++)
            {
                if(i < TileSetCount - 1)
                {
                    TileSetSizes.Add(i, MaxTileSetSize);
                    TileSetTileCount.Add(i, MaxTilesPerTileSet);
                }
                else
                {
